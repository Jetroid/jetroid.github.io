...
![The view from my hostel, looking north.]({{ site.url }}/assets/images/zagreb-hostel-view.jpg)
...
![City Library Zagreb.]({{ site.url }}/assets/images/zagreb-city-library.jpg)
...
![Behind the train station is this huge derelict building.]({{ site.url }}/assets/images/zagreb-concrete-structure.jpg)
...
![The National and University Library of Zagreb.]({{ site.url }}/assets/images/zagreb-university-library.jpg)
...
![Sveučilišna Livada Park. The path isn't aligned properly, which is mildly infuriating.]({{ site.url }}/assets/images/zagreb-university-library-park.jpg)
...
![]({{ site.url }}/assets/images/zagreb-green-point-exterior.jpg)
...
![Green Point's Menu. There's actually a second side which I didn't realise, which has all different kinds of Wok-based meals, and breakfast things.]({{ site.url }}/assets/images/zagreb-green-point-menu.jpg)
...
![Post-Its written by previous diners cover the walls of Green Point.]({{ site.url }}/assets/images/zagreb-green-point-walls.jpg)
...
![]({{ site.url }}/assets/images/zagreb-small-church.jpg)
![]({{ site.url }}/assets/images/zagreb-small-street.jpg)
...
![King Tomislav Square]({{ site.url }}/assets/images/zagreb-king-tomislav.jpg)
*King Tomislav Square.*

![A beautiful bridge inside a botanical garden.]({{ site.url }}/assets/images/zagreb-botanical-bridge.jpg)
...
![A mysterious note I found...]({{ site.url }}/assets/images/zagreb-mysterious-note.jpg)
...
![An advertisement for beer that reminded me of Hotline Miami.]({{ site.url }}/assets/images/zagreb-hotline-miami.jpg)
...
![The chimney from not so far away.]({{ site.url }}/assets/images/zagreb-big-chimney.jpg)
...
![I later found out that this particular art was painted by students from the local university.]({{ site.url }}/assets/images/zagreb-nice-graffiti.jpg)
...
![It feels just so extraordinarily big when you stand at the base. I had to take a panoramic shot to fit it all in, hence the distortion.]({{ site.url }}/assets/images/zagreb-big-chimney-base.jpg)
...
![]({{ site.url }}/assets/images/zagreb-collapsed-roof.jpg)
![]({{ site.url }}/assets/images/zagreb-rundown.jpg)
...
![]({{ site.url }}/assets/images/zagreb-hillhouse.jpg)
...
![]({{ site.url }}/assets/images/zagreb-train-panorama.jpg)
...
![I sat by this fountain so often that I was caught in people's Instagram pictures.]({{ site.url }}/assets/images/zagreb-sitting-by-fountain.jpg)
...
![I also sat in King Tomislav square fairly often. It's a less favourable spot though, as people go there to smoke. Judging by this picture there also seems to be some kind of spatial anomaly centred on my laptop. So watch out for that.]({{ site.url }}/assets/images/zagreb-sitting-by-king-tomislav.jpg)
