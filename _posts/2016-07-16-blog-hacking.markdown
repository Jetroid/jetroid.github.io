...
![Image of the hacking minigame in Fallout 3]({{ site.url }}/assets/images/content/hacking-minigame-reference.jpg)
...
![Image of the hacking minigame's lockout screen]({{ site.url }}/assets/images/content/hacking-minigame-lockout.png)
...
![Image of the old website]({{ site.url }}/assets/images/content/hacking-minigame-old-site.png)
